		...
		<div class="row">
			<div class="col-md-12">	
				<div class="post post-single">
					<h2 class="post-title" style="color: #4397CF; font-weight:700; font-size: 29px;">${eventBoard.bbsTitle}</h2>
					<div class="post-meta">
						<ul>
							<li>
					...
					<div class="post-thumb">
						<c:if test="${eventBoard.bbsPublic eq 'Y'}">
		            		<c:if test="${eventBoard.fileName ne ''}">
		            			<img class="img-responsive" src="/resources/upload/event/${eventBoard.fileName}" style="overflow:auto; width:1122px; height:680px;" alt="/resources/images/avater.jpg" >
		            		</c:if>
		            	
			            	<c:if test="${eventBoard.fileName eq ''}">
			            	<img class="img-responsive" src="/resources/upload/event/No-Image.png" style="overflow:auto; width:1122px; height:680px;" alt="/resources/images/avater.jpg" >
			            	</c:if>
		            	</c:if>
		            	...
		            	<c:if test="${eventBoard.bbsPublic eq 'N'}"> 
			            	<c:if test="${eventBoard.fileName ne ''}">
			            		<img class="img-responsive" src="/resources/upload/event/${eventBoard.fileName}" style="position:absolute; z-index:1; overflow:auto; width:1122px; height:680px;" alt="/resources/images/avater.jpg" >
				            	<img class="img-responsive" src="/resources/images/event/end.png" style="position:relative; z-index:100; overflow:auto; width:1122px; height:680px;;" alt="/resources/images/avater.jpg" >
			            	</c:if>
			            	
			            	<c:if test="${eventBoard.fileName eq ''}">
			            		<img class="img-responsive" src="/resources/images/event/end.png" style="overflow:auto; width:1122px; height:680px;;" alt="/resources/images/avater.jpg" >
			            	</c:if>
		            	</c:if>
					...
					<div class="post-content post-excerpt">
						...
						<blockquote class="quote-post">
				            <p><c:set var="Content" value="${eventBoard.bbsContent}" />&nbsp;&nbsp;&nbsp;&nbsp; ${fn:substring(Content,350,700)}</p>
				        </blockquote>
				        <p><c:set var="Content" value="${eventBoard.bbsContent}" />&nbsp;&nbsp;&nbsp;&nbsp; ${fn:substring(Content,700,9999999999)}</p>
				    </div>
