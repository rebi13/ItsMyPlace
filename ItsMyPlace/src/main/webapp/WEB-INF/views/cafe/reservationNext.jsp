...
function imageselect(phtNum, menuNums)
{
   ...
   basket2 += "                      <span class='p_num'><input type='text' name='p_num" + num + "' id='p_num" + num + "' size='2' maxlength='4' value='1' readonly/></span>";
...
function payment(){
	...
	if($("#rsrv_PplCnt").val() > $("#totalCount").val()){
		alert("예약인원보다 주문된 메뉴 수가 적습니다. 메뉴를 추가해주세요.");
		return;
	}
	...
	<div class="basketdiv" id="basket" style="margin:0 auto; padding:0;">
	    <div class="row head" style="margin:0 auto; padding:0;">
	        ...
	        <div class="subdiv">
	            ...
	            <div class="sum" style="font-size:18px; color:#333">합계</div>
	        </div>
	        <div class="subdiv">
