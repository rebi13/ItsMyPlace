...
<section class="user-dashboard page-wrapper">
	...
	<div class="container">
<h1 class="page-name">게시글 관리</h1><br><br>
		<div class="row">
		
			<div class="col-md-12">
				<ul class="list-inline dashboard-menu text-center">
					<li><a href="/admin/userList">회원 리스트</a></li>			
					<li><a href="/admin/userPoint">포인트 관리</a></li>
					<li><a class="active" href="/admin/userWrite">게시글 관리</a></li>
						...
						<table class="table">
							...
							<thead>
								<tr>
					                ...
					                <th scope="col" class="text-center" style="width:10%">회원명</th>
					                <th scope="col" class="text-center" style="width:10%">제목</th>
					                <th scope="col" class="text-center" style="width:10%">조회수</th>
					                <th scope="col" class="text-center" style="width:10%">작성일자</th>
					                <th scope="col" class="text-center" style="width:20%">기능</th>
								</tr>
							</thead>
							<tbody id="k_tbody">
								<tr>
