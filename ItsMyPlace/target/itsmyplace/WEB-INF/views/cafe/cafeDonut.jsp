		...
		<div class="row">
			...
			<div class="col-md-6">
				<ol class="product-pagination text-right">
					<li><a href="/cafe/cafeDamda"><i class="tf-ion-ios-arrow-left"></i> 이전 카페 </a></li>
					<li><a href="/cafe/cafeHanzan">다음 카페 <i class="tf-ion-ios-arrow-right"></i></a></li>
				</ol>
			</div>
		</div>
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						...
						<!-- 카페 소개 사진 슬라이드 시작 -->
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='/resources/images/shop/single-products/donut/product-1.png' alt='' data-zoom-image="/resources/images/shop/single-products/donut/product-1.png" />
								</div>
								<div class='item'>
									<img src='/resources/images/shop/single-products/donut/product-2.jpg' alt='' data-zoom-image="/resources/images/shop/single-products/donut/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='/resources/images/shop/single-products/donut/product-3.PNG' alt='' data-zoom-image="/resources/images/shop/single-products/donut/product-3.PNG" />
								</div>
								<div class='item'>
									<img src='/resources/images/shop/single-products/donut/product-4.PNG' alt='' data-zoom-image="/resources/images/shop/single-products/donut/product-4.PNG" />
								</div>
								<div class='item'>
									<img src='/resources/images/shop/single-products/donut/product-5.jpg' alt='' data-zoom-image="/resources/images/shop/single-products/donut/product-5.jpg" />
								</div>
								<div class='item'>
									<img src='/resources/images/shop/single-products/donut/product-6.jpeg' alt='' data-zoom-image="/resources/images/shop/single-products/donut/product-6.jpeg" />
								</div>
								<div class='item'>
									<img src='/resources/images/shop/single-products/donut/product-7.jpg' alt='' data-zoom-image="/resources/images/shop/single-products/donut/product-7.jpg" />
								</div>								
							</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='/resources/images/shop/single-products/donut/product-1.png' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='/resources/images/shop/single-products/donut/product-2.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='/resources/images/shop/single-products/donut/product-3.PNG' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='/resources/images/shop/single-products/donut/product-4.PNG' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='4'>
								<img src='/resources/images/shop/single-products/donut/product-5.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='5'>
								<img src='/resources/images/shop/single-products/donut/product-6.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='6'>
								<img src='/resources/images/shop/single-products/donut/product-7.jpg' alt='' />
							</li>		
						</ol>
					</div>
				</div>
...
<!-- 카페 설명 -->
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>커피 도넛</h2>
					<p class="product-price">#도넛 #인싸 #친절</p>
					
					<p class="product-description mt-20">
		
					Barista. Roasting. Coffee Bar. <br>
					Fresh Juice. Unique Donut. <br><br>

					전문 바리스타가 추출한 에스프레소 베이스의 커피 메뉴<br>					
					계절별 창작음료, 제철 과일만 사용하는 계절 생과일 쥬스<br>
					직접 반죽한 폭신하고 유니크한 도넛<br><br>

					좋은 품질의 커피와 최고의 서비스를 제공함으로써<br> 
					커피 문화를 만들어 가고 있는 커피 도넛입니다.<br>
					사르르 녹는 도넛과 함께 커피 한잔, 어떠실까요?<br><br>
					...
					BEST 티라미수 도넛<br>
					BEST 까망 라떼<br></p>
					<a href="/cafe/reservation?cafeNum=A0000002" class="btn btn-main mt-20">예약 하러가기</a>
				...
				<!-- 지도 시작 -->
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							<p><img class="media-object comment-avatar" src="/resources/images/blog/map/cafedonut.png" alt=""/></p>
						</div>
					<!-- 지도 종료 -->
