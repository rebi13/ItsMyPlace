...
function imageselect(phtNum, menuNums)
{
	...
	basket1 += "            <div class='img'><img src='/resources/images/shop/reservation/${cafe.userId}/menu/"+menuNameList+"/"+phtNum+".png' width='60'></div>";
...
<form name="orderform" id="orderform" method="post" class="orderform" action="/Page" onsubmit="return false;" style="margin:0 auto; padding:0; max-width:1170px;">    
   ...
   <div class="checkout shopping">
	...
	<div id="goorder" class="">
	<input type="hidden" name="dodoo" id="dodoo" value="haha"/>
            <div class="clear"></div>
            <div class="buttongroup center-align cmd">
...
<form name="insertForm" id="insertForm" method="post">
	<input type="hidden" name="ArsrvSeq" id="ArsrvSeq" value="" /> 
</form>
